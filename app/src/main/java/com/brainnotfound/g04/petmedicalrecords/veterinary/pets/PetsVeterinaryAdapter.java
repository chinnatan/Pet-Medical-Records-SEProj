...
public class PetsVeterinaryAdapter extends ArrayAdapter<Pets> {
    ...
    public PetsVeterinaryAdapter(Context context, int resource, List<Pets> objects, FragmentActivity fragmentActivity) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        final View _petsItem = LayoutInflater.from(context).inflate(R.layout.fragment_menu_veterinary_pets_item, parent, false);
        request = Request.getRequestInstance();

        TextView _codeTxt = _petsItem.findViewById(R.id.frg_menu_veterinary_pets_item_petcode);
        TextView _nameTxt = _petsItem.findViewById(R.id.frg_menu_veterinary_pets_item_name);
        TextView _typeTxt = _petsItem.findViewById(R.id.frg_menu_veterinary_pets_item_type);
        TextView _sexTxt = _petsItem.findViewById(R.id.frg_menu_veterinary_pets_item_sex);
        TextView _ageTxt = _petsItem.findViewById(R.id.frg_menu_veterinary_pets_item_age);
        TextView _statusTxt = _petsItem.findViewById(R.id.frg_menu_veterinary_pets_item_status);
        final ImageView _petImg = _petsItem.findViewById(R.id.frg_menu_veterinary_pets_item_image);
        Button _moreBtn = _petsItem.findViewById(R.id.frg_menu_veterinary_pets_item_moreBtn);
        ...
        _statusTxt.setText("สถานะ : " + request.getStatus());
